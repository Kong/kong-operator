...
func createKonnectEventGateway(
	ctx context.Context,
...
func updateKonnectEventGateway(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewaysSDK,
	obj *konnectv1alpha1.KonnectEventGateway,
) error {
	...
	if errWrap := wrapErrIfKonnectOpFailed(err, UpdateOp, obj); errWrap != nil {
		return handleUpdateError(ctx, err, obj, func(ctx context.Context) error {
			return createKonnectEventGateway(ctx, sdk, obj)
		})
	}
	return nil
}

func deleteKonnectEventGateway(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewaysSDK,
	obj *konnectv1alpha1.KonnectEventGateway,
) error {
...
func getKonnectEventGatewayForUID(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewaysSDK,
	obj *konnectv1alpha1.KonnectEventGateway,
) (string, error) {
