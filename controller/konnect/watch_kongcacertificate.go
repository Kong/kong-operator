	...
	return []func(*ctrl.Builder) *ctrl.Builder{
		...
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				&corev1.Secret{},
				handler.EnqueueRequestsFromMapFunc(
					enqueueKongCACertificateForSecret(cl),
				),
			)
		},
	}
...
// enqueueKongCACertificateForSecret enqueues KongCACertificate reconcile requests
// for KongCACertificates that reference the given Secret.
func enqueueKongCACertificateForSecret(cl client.Client) func(ctx context.Context, obj client.Object) []reconcile.Request {
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
		...
		// List all KongCACertificates that reference this Secret.
		var certList configurationv1alpha1.KongCACertificateList
		if err := cl.List(ctx, &certList, client.MatchingFields{
			index.IndexFieldKongCACertificateReferencesSecrets: secret.Namespace + "/" + secret.Name,
		}); err != nil {
			return nil
		}
