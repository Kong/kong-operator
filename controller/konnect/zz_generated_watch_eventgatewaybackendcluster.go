...
// EventGatewayBackendClusterReconciliationWatchOptions returns the watch options for
// the EventGatewayBackendCluster.
	...
	return []func(*ctrl.Builder) *ctrl.Builder{
		...
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(
					enqueueEventGatewayBackendClusterForKonnectEventGateway(cl),
				),
			)
		},
		func(b *ctrl.Builder) *ctrl.Builder {
		...
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				&corev1.Secret{},
				handler.EnqueueRequestsFromMapFunc(
					enqueueObjectsForSecretRef[configurationv1alpha1.EventGatewayBackendClusterList](cl),
				),
			)
		},
	}
...
func enqueueEventGatewayBackendClusterForKonnectEventGateway(
	cl client.Client,
