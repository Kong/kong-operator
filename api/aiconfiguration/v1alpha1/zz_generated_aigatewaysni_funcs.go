...
func (obj *AIGatewaySNI) GetKonnectLabels() map[string]string {
...
func (obj *AIGatewaySNI) SetKonnectLabels(labels map[string]string) {
	if labels == nil {
...
// GetKonnectStatus returns the Konnect status contained in the AIGatewaySNI status.
func (obj *AIGatewaySNI) GetKonnectStatus() *konnectv1alpha2.KonnectEntityStatus {
	return &obj.Status.KonnectEntityStatus
}

// SetKonnectID sets the Konnect ID in the AIGatewaySNI status.
func (obj *AIGatewaySNI) SetKonnectID(id string) {
	obj.Status.ID = id
}

// GetKonnectID returns the Konnect ID in the AIGatewaySNI status.
func (obj *AIGatewaySNI) GetKonnectID() string {
	return obj.Status.ID
}

// GetKonnectName returns the AIGatewaySNI's identifying name (the Konnect
// API's "name" field), distinct from GetName's Kubernetes object name.
func (obj *AIGatewaySNI) GetKonnectName() string {
	return string(obj.Spec.APISpec.Name)
}

// GetTypeName returns the AIGatewaySNI Kind name.
func (obj AIGatewaySNI) GetTypeName() string {
	return "AIGatewaySNI"
}

// GetItems returns the list of AIGatewaySNI items.
func (obj AIGatewaySNIList) GetItems() []AIGatewaySNI {
	return obj.Items
}

// HasParent returns true if the AIGatewaySNI has a parent entity.
func (obj AIGatewaySNI) HasParent() bool {
	return true
}

// GetConditions returns the Status Conditions.
func (obj *AIGatewaySNI) GetConditions() []metav1.Condition {
	return obj.Status.Conditions
}

// SetConditions sets the Status Conditions.
func (obj *AIGatewaySNI) SetConditions(conditions []metav1.Condition) {
	obj.Status.Conditions = conditions
}

// GetGatewayID returns the Konnect ID of the parent Gateway.
func (obj *AIGatewaySNI) GetGatewayID() string {
...
func (obj *AIGatewaySNI) SetGatewayID(id string) {
	if obj.Status.GatewayID == nil {
...
func (obj *AIGatewaySNI) GetAIGatewayRef() AIGatewayRef {
...
func (obj *AIGatewaySNI) GetParentRef() commonv1alpha1.ObjectRef {
...
func (obj *AIGatewaySNI) SetParentRef(ref commonv1alpha1.ObjectRef) {
...
func (obj *AIGatewaySNI) GetStatusConditionTypeParentRefValid() string {
...
func (obj *AIGatewaySNI) GetStatusConditionReasonParentRefValid() string {
...
func (obj *AIGatewaySNI) GetStatusConditionReasonParentRefInvalid() string {
...
func (obj *AIGatewaySNI) GetStatusConditionReasonParentRefNotProgrammed() string {
...
func (obj *AIGatewaySNI) GetAncestorIDs() map[string]string {
...
func (obj *AIGatewaySNI) SetAncestorID(kind, id string) {
	switch kind {
