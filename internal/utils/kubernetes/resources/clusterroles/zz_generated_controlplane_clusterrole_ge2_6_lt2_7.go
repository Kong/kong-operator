...
// GenerateNewClusterRoleForControlPlane_ge2_6_lt2_7 is a helper to generate a ClusterRole
// resource with all the permissions needed by the controlplane deployment.
// It is used for controlplanes that match the semver constraint ">=2.6,<2.7"
func GenerateNewClusterRoleForControlPlane_ge2_6_lt2_7(controlplaneName string) *rbacv1.ClusterRole {
