...
//+kubebuilder:rbac:groups=core,resources=nodes;secrets,verbs=list;watch
...
//+kubebuilder:rbac:groups=gateway.networking.k8s.io,resources=gatewayclasses;grpcroutes;httproutes;referencegrants;tcproutes;tlsroutes;udproutes,verbs=get;list;watch
