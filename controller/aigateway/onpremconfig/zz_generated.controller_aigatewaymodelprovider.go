...
// -----------------------------------------------------------------------------
// aiconfigurationv1alpha1 AIGatewayModelProvider - Reconciler
// -----------------------------------------------------------------------------

// AIGatewayModelProviderReconciler reconciles AIGatewayModelProvider resources
type AIGatewayModelProviderReconciler struct {
	client.Client
...
var _ controllers.Reconciler = &AIGatewayModelProviderReconciler{}

// SetupWithManager sets up the controller with the Manager.
func (r *AIGatewayModelProviderReconciler) SetupWithManager(mgr ctrl.Manager) error {
	blder := ctrl.NewControllerManagedBy(mgr).
		// set the controller name
		Named("aiconfigurationv1alpha1AIGatewayModelProvider").
...
func (r *AIGatewayModelProviderReconciler) SetLogger(l logr.Logger) {
	r.Log = l
}

// SetCommonFields sets the shared controller dependencies.
func (r *AIGatewayModelProviderReconciler) SetCommonFields(
...
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaymodelproviders,verbs=get;list;watch
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaymodelproviders/status,verbs=get;update;patch

// Reconcile processes the watched objects
func (r *AIGatewayModelProviderReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	if r.Cache == nil {
		r.Cache = make(map[types.NamespacedName]types.NamespacedName)
	}
	obj := new(aiconfigurationv1alpha1.AIGatewayModelProvider)
	logger := r.Log.
		WithValues("aiconfigurationv1alpha1AIGatewayModelProvider", req.NamespacedName).
	...
	if err := r.Get(ctx, req.NamespacedName, obj); err != nil {
		if apierrors.IsNotFound(err) {
			...
			if parent, ok := r.Cache[req.NamespacedName]; ok {
				...
				obj.Name = req.Name
				obj.Kind = "AIGatewayModelProvider"
