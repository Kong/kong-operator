...
func (in *Config) DeepCopyInto(out *Config) {
	*out = *in
	...
	if in.ConfigPollInterval != nil {
		in, out := &in.ConfigPollInterval, &out.ConfigPollInterval
		*out = new(v1.Duration)
		**out = **in
	}
...
func (in *DataPlaneSpec) DeepCopyInto(out *DataPlaneSpec) {
	*out = *in
	out.KonnectEventGatewayRef = in.KonnectEventGatewayRef
...
func (in *ObservabilityConfig) DeepCopyInto(out *ObservabilityConfig) {
	*out = *in
	...
	if in.PolicyErrorsInfoLogInterval != nil {
		in, out := &in.PolicyErrorsInfoLogInterval, &out.PolicyErrorsInfoLogInterval
		*out = new(v1.Duration)
		**out = **in
	}
}
...
func (in *ServiceOptions) DeepCopyInto(out *ServiceOptions) {
	*out = *in
	...
	if in.Labels != nil {
		...
		*out = make(map[v1beta1.LabelName]v1beta1.LabelValue, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
