...
type AIGatewayConsumer struct {
	...
	// +optional
	Spec AIGatewayConsumerSpec `json:"spec,omitzero"`

	// +optional
	Status AIGatewayConsumerStatus `json:"status,omitzero"`
}

// AIGatewayConsumerList contains a list of AIGatewayConsumer.
//
// +kubebuilder:object:root=true
type AIGatewayConsumerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []AIGatewayConsumer `json:"items"`
}

// AIGatewayConsumerSpec defines the desired state of AIGatewayConsumer.
type AIGatewayConsumerSpec struct {
...
type AIGatewayConsumerAPISpec struct {
	// Identifier for mapping the consumer when using OAuth authentication.
	//
	// +optional
	// +kubebuilder:validation:MaxLength=253
	CustomID string `json:"customID,omitzero"`
...
type AIGatewayConsumerStatus struct {
