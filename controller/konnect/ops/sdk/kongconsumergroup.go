...
type ConsumerGroupSDK interface {
	...
	GetConsumerGroup(ctx context.Context, consumerGroupID string, controlPlaneID string, opts ...sdkkonnectops.Option) (*sdkkonnectops.GetConsumerGroupResponse, error)
}
