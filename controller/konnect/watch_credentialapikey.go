...
// kongCredentialAPIKeyReconciliationWatchOptions returns the watch options for
// the KongCredentialAPIKey.
func kongCredentialAPIKeyReconciliationWatchOptions(
	cl client.Client,
	...
	return []func(*ctrl.Builder) *ctrl.Builder{
		...
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(
					kongCredentialAPIKeyForKonnectAPIAuthConfiguration(cl),
				),
			)
		},
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(
					kongCredentialAPIKeyForKonnectGatewayControlPlane(cl),
				),
			)
		},
	}
...
func kongCredentialAPIKeyForKonnectAPIAuthConfiguration(
	cl client.Client,
...
func kongCredentialAPIKeyForKonnectGatewayControlPlane(
	cl client.Client,
) func(ctx context.Context, obj client.Object) []reconcile.Request {
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
...
func kongCredentialAPIKeyForKongConsumer(
	cl client.Client,
) func(ctx context.Context, obj client.Object) []reconcile.Request {
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
