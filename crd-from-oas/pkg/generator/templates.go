...
//
// The condition constants and sentinel error types themselves live in the
// shared commonv1alpha1 package (see api/common/v1alpha1/references.go) so
// that they are defined exactly once instead of once per generated API
// package. This file only re-exports them as aliases so existing unqualified
// references (both in hand-written and other generated code in this package)
// keep compiling.
...
import (
	commonv1alpha1 "` + commonV1Alpha1ImportPath + `"
)
