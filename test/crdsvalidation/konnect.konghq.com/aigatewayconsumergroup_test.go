...
func validAIGatewayConsumerGroup(ns string) *konnectv1alpha1.AIGatewayConsumerGroup {
	return &konnectv1alpha1.AIGatewayConsumerGroup{
		...
		Spec: konnectv1alpha1.AIGatewayConsumerGroupSpec{
			...
			APISpec: konnectv1alpha1.AIGatewayConsumerGroupAPISpec{
				...
				DisplayName: "Test Consumer Group",
			},
		},
	}
}
...
func TestAIGatewayConsumerGroup(t *testing.T) {
	...
	t.Run("apiSpec.policies validation", func(t *testing.T) {
		common.TestCasesGroup[*konnectv1alpha1.AIGatewayConsumerGroup]{
			{
				Name: "policies ref with name only is valid (kind defaulted)",
				TestObject: func() *konnectv1alpha1.AIGatewayConsumerGroup {
					obj := validAIGatewayConsumerGroup(ns.Name)
					obj.Spec.APISpec.Policies = []konnectv1alpha1.AIGatewayPolicyRef{
						{Name: "test-policy"},
					}
					return obj
				}(),
				Assert: func(t *testing.T, obj *konnectv1alpha1.AIGatewayConsumerGroup) {
