...
func main() {
	...
	docsMarkdown := generateDocs(cfg)
	fmt.Print(docsMarkdown)
}

func generateDocs(cfg *config.CLIConfig) string {
	var markdown strings.Builder
	writePreamble(&markdown)
	cfg.FlagSet().VisitAll(visit(&markdown))
	writeClosure(&markdown)
	return markdown.String()
}

func visit(markdown *strings.Builder) func(*pflag.Flag) {
