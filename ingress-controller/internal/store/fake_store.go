...
func (objects FakeObjects) MarshalToYAML() ([]byte, error) {
	...
	typeToGVK := map[reflect.Type]schema.GroupVersionKind{
		...
		reflect.TypeFor[*configurationv1.KongConsumer]():                 configurationv1.GroupVersion.WithKind("KongConsumer"),
		reflect.TypeFor[*configurationv1beta1.KongConsumerGroup]():       configurationv1beta1.GroupVersion.WithKind("KongConsumerGroup"),
		reflect.TypeFor[*configurationv1alpha1.KongVault]():              configurationv1alpha1.GroupVersion.WithKind(configurationv1alpha1.KongVaultKind),
		reflect.TypeFor[*configurationv1alpha1.KongCustomEntity]():       configurationv1alpha1.GroupVersion.WithKind(configurationv1alpha1.KongCustomEntityKind),
	}
