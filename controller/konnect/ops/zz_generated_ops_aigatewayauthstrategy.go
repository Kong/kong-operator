...
func createAIGatewayAuthStrategy(
	...
	req, err := obj.ToCreateAIGatewayAuthStrategyRequest(ctx, cl)
	if err != nil {
		return fmt.Errorf("failed creating %s SDK request: %w", obj.GetTypeName(), err)
	}

	resp, err := sdk.CreateAiGatewayAuthStrategy(ctx, parentID, *req)
	...
	respRootUnionJSON, err := json.Marshal(resp.AIGatewayAuthStrategy)
	if err != nil {
...
func updateAIGatewayAuthStrategy(
	ctx context.Context,
	cl client.Client,
	sdk sdkkonnectgo.AIGatewayAuthStrategiesSDK,
	obj *aiconfigurationv1alpha1.AIGatewayAuthStrategy,
	...
	req, err := obj.ToUpdateAIGatewayAuthStrategyRequest(ctx, cl)
	if err != nil {
		return fmt.Errorf("failed building %s SDK update request: %w", obj.GetTypeName(), err)
	}

	_, err = sdk.UpdateAiGatewayAuthStrategy(ctx, sdkkonnectops.UpdateAiGatewayAuthStrategyRequest{
		GatewayID:                          parentID,
		AuthStrategyIDOrName:               id,
	...
	if errWrap := wrapErrIfKonnectOpFailed(err, UpdateOp, obj); errWrap != nil {
		return handleUpdateError(ctx, err, obj, func(ctx context.Context) error {
			return createAIGatewayAuthStrategy(ctx, cl, sdk, obj)
		})
	}
	return nil
}
...
func deleteAIGatewayAuthStrategy(
	...
	_, err := sdk.DeleteAiGatewayAuthStrategy(ctx, parentID, id)
...
func getAIGatewayAuthStrategyForUID(
	...
	// TODO: AIGatewayAuthStrategy's Konnect list response lacks labels/tags and no
