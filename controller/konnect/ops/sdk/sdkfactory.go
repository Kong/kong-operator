...
func (w sdkWrapper) GetControlPlaneGroupSDK() sdkkonnectgo.ControlPlaneGroupsSDK {
...
// GetConfigStoreSecretsSDK returns the SDK to operate Konnect config store secrets.
