...
//+kubebuilder:rbac:groups=configuration.konghq.com,resources=credentialbasicauths,verbs=get;list;watch
//+kubebuilder:rbac:groups=configuration.konghq.com,resources=credentialbasicauths/status,verbs=get;update;patch
