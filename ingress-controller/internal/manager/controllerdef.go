...
func setupControllers(
	...
	controllers := []ControllerDef{
		...
		// v1alpha1 Kong Gateway entity controllers (KIC standalone mode).
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongServiceReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongServiceV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongRouteReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongRouteV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongUpstreamReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongUpstreamV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongTargetReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongTargetV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		},
		{
			...
			Controller: &configuration.KongV1Alpha1KongCertificateReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongCertificateV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongCACertificateReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongCACertificateV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongSNIReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongSNIV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
		...
		{
			Enabled: featureGates.Enabled(managercfg.KongServiceV1Alpha1Feature),
			Controller: &configuration.KongV1Alpha1KongPluginBindingReconciler{
				Client:                     mgr.GetClient(),
				Log:                        ctrl.LoggerFrom(ctx).WithName("controllers").WithName("KongPluginBindingV1Alpha1"),
				Scheme:                     mgr.GetScheme(),
				DataplaneClient:            dataplaneClient,
				CacheSyncTimeout:           c.CacheSyncTimeout,
				IngressClassName:           c.IngressClassName,
