...
// kongCredentialHMACReconciliationWatchOptions returns the watch options for
// the KongCredentialHMAC resource.
func kongCredentialHMACReconciliationWatchOptions(
	cl client.Client,
) []func(*ctrl.Builder) *ctrl.Builder {
	return []func(*ctrl.Builder) *ctrl.Builder{
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.For(&configurationv1alpha1.KongCredentialHMAC{},
				builder.WithPredicates(
					predicate.NewPredicateFuncs(
						kongCredentialRefersToKonnectGatewayControlPlane[*configurationv1alpha1.KongCredentialHMAC](cl),
					),
				),
			)
		},
		...
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(
					kongCredentialHMACForKonnectAPIAuthConfiguration(cl),
				),
			)
		},
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(
					kongCredentialHMACForKonnectGatewayControlPlane(cl),
				),
			)
		},
	}
...
func kongCredentialHMACForKonnectAPIAuthConfiguration(
	cl client.Client,
...
func kongCredentialHMACForKonnectGatewayControlPlane(
	cl client.Client,
) func(ctx context.Context, obj client.Object) []reconcile.Request {
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
...
func kongCredentialHMACForKongConsumer(
	cl client.Client,
) func(ctx context.Context, obj client.Object) []reconcile.Request {
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
