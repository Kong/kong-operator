...
func (c *dataPlaneMetricsExtensions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataPlaneMetricsExtension, err error) {
	result = &v1alpha1.DataPlaneMetricsExtension{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataPlaneMetricsExtensions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataPlaneMetricsExtensionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataPlaneMetricsExtensionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dataplanemetricsextensions").
...
func (c *dataPlaneMetricsExtensions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataPlaneMetricsExtensions) Create(ctx context.Context, dataPlaneMetricsExtension *v1alpha1.DataPlaneMetricsExtension, opts v1.CreateOptions) (result *v1alpha1.DataPlaneMetricsExtension, err error) {
	result = &v1alpha1.DataPlaneMetricsExtension{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dataplanemetricsextensions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataPlaneMetricsExtension).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dataPlaneMetricsExtensions) Update(ctx context.Context, dataPlaneMetricsExtension *v1alpha1.DataPlaneMetricsExtension, opts v1.UpdateOptions) (result *v1alpha1.DataPlaneMetricsExtension, err error) {
	result = &v1alpha1.DataPlaneMetricsExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataplanemetricsextensions").
		Name(dataPlaneMetricsExtension.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataPlaneMetricsExtension).
		Do(ctx).
		Into(result)
...
func (c *dataPlaneMetricsExtensions) UpdateStatus(ctx context.Context, dataPlaneMetricsExtension *v1alpha1.DataPlaneMetricsExtension, opts v1.UpdateOptions) (result *v1alpha1.DataPlaneMetricsExtension, err error) {
	result = &v1alpha1.DataPlaneMetricsExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataplanemetricsextensions").
...
func (c *dataPlaneMetricsExtensions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataPlaneMetricsExtensions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataPlaneMetricsExtensions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataPlaneMetricsExtension, err error) {
	result = &v1alpha1.DataPlaneMetricsExtension{}
