...
func validAIGatewayConsumerGroup(ns string) *aiconfigurationv1alpha1.AIGatewayConsumerGroup {
...
func TestAIGatewayConsumerGroup(t *testing.T) {
	...
	t.Run("apiSpec.policies validation", func(t *testing.T) {
		common.TestCasesGroup[*aiconfigurationv1alpha1.AIGatewayConsumerGroup]{
			{
				Name: "policies ref with name only is valid (kind defaulted)",
				TestObject: func() *aiconfigurationv1alpha1.AIGatewayConsumerGroup {
				...
				Assert: func(t *testing.T, obj *aiconfigurationv1alpha1.AIGatewayConsumerGroup) {
