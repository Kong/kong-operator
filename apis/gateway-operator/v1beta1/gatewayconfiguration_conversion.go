...
func (g *GatewayConfiguration) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst.Spec.Extensions = convertExtensionRefsToExternal(extensions)
...
func (g *GatewayConfiguration) ConvertFrom(srcRaw conversion.Hub) error {
	...
	g.Spec.Extensions = lo.Filter(convertExtensionRefsFromExternal(src.Spec.Extensions), func(ext commonv1alpha1.ExtensionRef, _ int) bool {
	...
	if src.Spec.ControlPlaneOptions != nil {
		...
		g.Spec.ControlPlaneOptions.Extensions = lo.Filter(convertExtensionRefsFromExternal(src.Spec.Extensions), func(ext commonv1alpha1.ExtensionRef, _ int) bool {
