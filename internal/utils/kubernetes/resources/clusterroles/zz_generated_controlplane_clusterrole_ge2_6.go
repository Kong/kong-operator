...
// GenerateNewClusterRoleForControlPlane_ge2_6 is a helper to generate a ClusterRole
// resource with all the permissions needed by the controlplane deployment.
// It is used for controlplanes that match the semver constraint ">=2.6"
func GenerateNewClusterRoleForControlPlane_ge2_6(controlplaneName string) *rbacv1.ClusterRole {
