...
// GenerateNewClusterRoleForControlPlane_ge2_9 is a helper to generate a ClusterRole
// resource with all the permissions needed by the controlplane deployment.
// It is used for controlplanes that match the semver constraint ">=2.9"
func GenerateNewClusterRoleForControlPlane_ge2_9(controlplaneName string) *rbacv1.ClusterRole {
