...
// addToCleanup has to be used in tests which work with ControlPlane v2beta1.
...
// the v1beta1 API group which clears v2beta1 fields
// (because the v1beta1 API group does not have them).
// Since v2beta1 ControlPlane have validation rules and objects of this type
