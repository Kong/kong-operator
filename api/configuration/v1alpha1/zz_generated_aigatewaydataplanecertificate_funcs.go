...
func (obj *AIGatewayDataPlaneCertificate) GetAIGatewayControlPlaneRef() commonv1alpha1.ObjectRef {
...
func (obj *AIGatewayDataPlaneCertificate) SetAncestorID(kind, id string) {
	switch kind {
