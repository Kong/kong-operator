...
generate: generate.crds generate.crd-kustomize generate.k8sio-gomod-replace generate.deepcopy generate.apitypes-funcs generate.docs generate.lint-fix manifests test.charts.golden.update generate.cli-arguments-docs test.ingress-controller.golden.update
...
.PHONY: test.ingress-controller.golden.update
	@go test -v -run TestKongClient_GoldenTests ./ingres-controller/internal/dataplane -update
