...
func (kgcp *KonnectGatewayControlPlane) GetKonnectStatus() *konnectv1alpha2.KonnectEntityStatus {
	return &kgcp.Status.KonnectEntityStatus
}

// GetKonnectID returns the Konnect ID in the KonnectGatewayControlPlane status.
func (kgcp *KonnectGatewayControlPlane) GetKonnectID() string {
	return kgcp.Status.ID
}

// SetKonnectID sets the Konnect ID in the KonnectGatewayControlPlane status.
func (kgcp *KonnectGatewayControlPlane) SetKonnectID(id string) {
	kgcp.Status.ID = id
}

// GetTypeName returns the KonnectGatewayControlPlane Kind name
func (kgcp KonnectGatewayControlPlane) GetTypeName() string {
	return "KonnectGatewayControlPlane"
}

// GetConditions returns the Status Conditions
func (kgcp *KonnectGatewayControlPlane) GetConditions() []metav1.Condition {
	return kgcp.Status.Conditions
}

// SetConditions sets the Status Conditions
func (kgcp *KonnectGatewayControlPlane) SetConditions(conditions []metav1.Condition) {
	kgcp.Status.Conditions = conditions
}
...
func (obj *KonnectCloudGatewayNetwork) GetKonnectStatus() *konnectv1alpha2.KonnectEntityStatus {
