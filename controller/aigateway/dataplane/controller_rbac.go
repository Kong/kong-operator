...
// -----------------------------------------------------------------------------
// AIGatewayDataPlane Reconciler - RBAC
// -----------------------------------------------------------------------------
...
// +kubebuilder:rbac:groups=aigateway.konghq.com,resources=onpremaigateways,verbs=get;list;watch
// +kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaydataplanecertificates,verbs=create;get;list;watch;update;patch;delete
