...
type PortalTeamAPISpec struct {
	...
	// Whether the team's membership is managed by Konnect instead of being synced
	// from an identity provider's team mappings.
	...
	//
	// +optional
	KonnectManaged KonnectManaged `json:"konnectManaged,omitzero"`
