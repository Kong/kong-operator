...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayControlPlaneOptions) DeepCopyInto(out *GatewayControlPlaneOptions) {
	*out = *in
	if in.Source != nil {
	...
	if in.Mirror != nil {
		...
		*out = new(konnectv1alpha1.MirrorSpec)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayControlPlaneOptions.
func (in *GatewayControlPlaneOptions) DeepCopy() *GatewayControlPlaneOptions {
	if in == nil {
		return nil
	}
	out := new(GatewayControlPlaneOptions)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KonnectOptions) DeepCopyInto(out *KonnectOptions) {
	*out = *in
	if in.APIAuthConfigurationSpec != nil {
		in, out := &in.APIAuthConfigurationSpec, &out.APIAuthConfigurationSpec
		*out = new(konnectv1alpha1.KonnectAPIAuthConfigurationSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.GatewayControlPlaneOptions != nil {
		in, out := &in.GatewayControlPlaneOptions, &out.GatewayControlPlaneOptions
		*out = new(GatewayControlPlaneOptions)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KonnectOptions.
func (in *KonnectOptions) DeepCopy() *KonnectOptions {
	if in == nil {
		return nil
	}
	out := new(KonnectOptions)
