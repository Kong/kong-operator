...
func (objects FakeObjects) MarshalToYAML() ([]byte, error) {
	...
	typeToGVK := map[reflect.Type]schema.GroupVersionKind{
		...
		reflect.TypeFor[*gatewayapi.HTTPRoute]():                         gatewayv1.SchemeGroupVersion.WithKind("HTTPRoute"),
		reflect.TypeFor[*gatewayapi.UDPRoute]():                          gatewayv1alpha2.SchemeGroupVersion.WithKind("UDPRoute"),
		reflect.TypeFor[*gatewayapi.TCPRoute]():                          gatewayv1alpha2.SchemeGroupVersion.WithKind("TCPRoute"),
		reflect.TypeFor[*gatewayapi.TLSRoute]():                          gatewayv1alpha2.SchemeGroupVersion.WithKind("TLSRoute"),
		reflect.TypeFor[*gatewayapi.GRPCRoute]():                         gatewayv1.SchemeGroupVersion.WithKind("GRPCRoute"),
		reflect.TypeFor[*gatewayapi.ReferenceGrant]():                    gatewayv1beta1.SchemeGroupVersion.WithKind("ReferenceGrant"),
		reflect.TypeFor[*gatewayapi.Gateway]():                           gatewayv1.SchemeGroupVersion.WithKind("Gateway"),
		reflect.TypeFor[*gatewayapi.BackendTLSPolicy]():                  gatewayv1alpha3.SchemeGroupVersion.WithKind("BackendTLSPolicy"),
		...
		reflect.TypeFor[*configurationv1.KongPlugin]():                   configurationv1.SchemeGroupVersion.WithKind("KongPlugin"),
		reflect.TypeFor[*configurationv1.KongClusterPlugin]():            configurationv1.SchemeGroupVersion.WithKind("KongClusterPlugin"),
		reflect.TypeFor[*configurationv1.KongConsumer]():                 configurationv1.SchemeGroupVersion.WithKind("KongConsumer"),
		reflect.TypeFor[*configurationv1beta1.KongConsumerGroup]():       configurationv1beta1.SchemeGroupVersion.WithKind("KongConsumerGroup"),
		reflect.TypeFor[*configurationv1alpha1.KongVault]():              configurationv1alpha1.SchemeGroupVersion.WithKind(configurationv1alpha1.KongVaultKind),
		reflect.TypeFor[*configurationv1alpha1.KongCustomEntity]():       configurationv1alpha1.SchemeGroupVersion.WithKind(configurationv1alpha1.KongCustomEntityKind),
	}
