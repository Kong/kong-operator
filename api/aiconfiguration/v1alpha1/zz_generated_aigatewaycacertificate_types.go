...
type AIGatewayCACertificate struct {
	...
	// +optional
	Spec AIGatewayCACertificateSpec `json:"spec,omitzero"`

	// +optional
	Status AIGatewayCACertificateStatus `json:"status,omitzero"`
}

// AIGatewayCACertificateList contains a list of AIGatewayCACertificate.
//
// +kubebuilder:object:root=true
type AIGatewayCACertificateList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []AIGatewayCACertificate `json:"items"`
}

// AIGatewayCACertificateSpec defines the desired state of AIGatewayCACertificate.
type AIGatewayCACertificateSpec struct {
	...
	//
	// +optional
	APISpec AIGatewayCACertificateAPISpec `json:"apiSpec,omitzero"`
}

// AIGatewayCACertificateAPISpec defines the API spec fields for AIGatewayCACertificate.
type AIGatewayCACertificateAPISpec struct {
...
type AIGatewayCACertificateStatus struct {
