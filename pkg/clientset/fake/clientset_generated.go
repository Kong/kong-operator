...
import (
	clientset "github.com/kong/kong-operator/pkg/clientset"
	configurationv1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1"
	fakeconfigurationv1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1/fake"
	configurationv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1alpha1"
	fakeconfigurationv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1alpha1/fake"
	configurationv1beta1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1beta1"
	fakeconfigurationv1beta1 "github.com/kong/kong-operator/pkg/clientset/typed/configuration/v1beta1/fake"
	gatewayoperatorv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v1alpha1"
	fakegatewayoperatorv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v1alpha1/fake"
	gatewayoperatorv1beta1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v1beta1"
	fakegatewayoperatorv1beta1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v1beta1/fake"
	gatewayoperatorv2beta1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v2beta1"
	fakegatewayoperatorv2beta1 "github.com/kong/kong-operator/pkg/clientset/typed/gateway-operator/v2beta1/fake"
	incubatorv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/incubator/v1alpha1"
	fakeincubatorv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/incubator/v1alpha1/fake"
	konnectv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/konnect/v1alpha1"
	fakekonnectv1alpha1 "github.com/kong/kong-operator/pkg/clientset/typed/konnect/v1alpha1/fake"
	konnectv1alpha2 "github.com/kong/kong-operator/pkg/clientset/typed/konnect/v1alpha2"
	fakekonnectv1alpha2 "github.com/kong/kong-operator/pkg/clientset/typed/konnect/v1alpha2/fake"
