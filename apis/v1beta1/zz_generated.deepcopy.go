...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneMetricOptions) DeepCopyInto(out *DataPlaneMetricOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataPlaneMetricOptions.
func (in *DataPlaneMetricOptions) DeepCopy() *DataPlaneMetricOptions {
	if in == nil {
		return nil
	}
	out := new(DataPlaneMetricOptions)
	in.DeepCopyInto(out)
	return out
}
