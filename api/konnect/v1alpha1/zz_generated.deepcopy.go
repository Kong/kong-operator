...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (kgcp *KonnectGatewayControlPlane) DeepCopyInto(out *KonnectGatewayControlPlane) {
	*out = *kgcp
	out.TypeMeta = kgcp.TypeMeta
	kgcp.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	kgcp.Spec.DeepCopyInto(&out.Spec)
	kgcp.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KonnectGatewayControlPlane.
func (kgcp *KonnectGatewayControlPlane) DeepCopy() *KonnectGatewayControlPlane {
	if kgcp == nil {
		return nil
	}
	out := new(KonnectGatewayControlPlane)
	kgcp.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (kgcp *KonnectGatewayControlPlane) DeepCopyObject() runtime.Object {
	if c := kgcp.DeepCopy(); c != nil {
		return c
	}
	return nil
}
