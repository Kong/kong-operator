...
func NewCRDValidationTestCasesGroupCPRefChange[
	...
	}
	{
		if objScope == meta.RESTScopeNameNamespace {
			...
			if lo.Contains([]string{"KongService", "KongRoute", "KongUpstream", "KongCertificate", "KongCACertificate", "KongConsumerGroup", "KongKeySet"}, obj.GetObjectKind().GroupVersionKind().Kind) {
