...
func expectedParentIngress() *netv1.Ingress {
	return &netv1.Ingress{
		...
		Name: "test-ingress", Namespace: corev1.NamespaceDefault,
	}
}
			...
			expected: map[string]kongstate.Service{
				"default.test-service.80": {
					...
					Routes: []kongstate.Route{{
						...
						Name: new("default.test-ingress.test-service..80"),
						Paths: kong.StringSlice(
							"/v1/api",
							"/v2/api",
							"/v3/api",
		...
		},
		{
			...
			expected: map[string]kongstate.Service{
				"default.test-service1.80": {
					Namespace: corev1.NamespaceDefault,
					Service: kong.Service{
						Name:           new("default.test-service1.80"),
						Host:           new("test-service1.default.80.svc"),
						ConnectTimeout: defaultServiceTimeoutInKongFormat(),
						Path:           new("/"),
						Port:           new(80),
						Protocol:       new("http"),
					...
					Routes: []kongstate.Route{
						{
							...
							Name:              new("default.test-ingress.test-service1.konghq.com.80"),
							Hosts:             kong.StringSlice("konghq.com"),
							Paths:             kong.StringSlice("/v1/api"),
							PreserveHost:      new(true),
							Protocols:         nil,
				...
				"default.test-service2.80": {
					Namespace: corev1.NamespaceDefault,
					Service: kong.Service{
						Name:           new("default.test-service2.80"),
						Host:           new("test-service2.default.80.svc"),
						ConnectTimeout: defaultServiceTimeoutInKongFormat(),
						Path:           new("/"),
						Port:           new(80),
						Protocol:       new("http"),
					...
					Routes: []kongstate.Route{
						{
							...
							Name:              new("default.test-ingress.test-service2.konghq.com.80"),
							Hosts:             kong.StringSlice("konghq.com"),
		...
		},
		{
			...
			expected: map[string]kongstate.Service{
				"default.ad-service.80": {
					Namespace: corev1.NamespaceDefault,
					Service: kong.Service{
						Name:           new("default.ad-service.80"),
						Host:           new("ad-service.default.80.svc"),
						ConnectTimeout: defaultServiceTimeoutInKongFormat(),
						Path:           new("/"),
						Port:           new(80),
						Protocol:       new("http"),
					...
					Routes: []kongstate.Route{
						{
							...
							Name:              new("default.test-ingress.ad-service.konghq.com.80"),
							Hosts:             kong.StringSlice("konghq.com"),
							Paths:             kong.StringSlice("/v1/api"),
							PreserveHost:      new(true),
							Protocols:         nil,
				...
				"default.mad-service.80": {
					Namespace: corev1.NamespaceDefault,
					Service: kong.Service{
						Name:           new("default.mad-service.80"),
						Host:           new("mad-service.default.80.svc"),
						ConnectTimeout: defaultServiceTimeoutInKongFormat(),
						Path:           new("/"),
						Port:           new(80),
						Protocol:       new("http"),
					...
					Routes: []kongstate.Route{
						{
							...
							Name:              new("default.test-ingress.mad-service.konghq.co.80"),
			...
			expected: map[string]kongstate.Service{
				"default.test-service.80": {
					...
					Routes: []kongstate.Route{{
						...
						Name:              new("default.test-ingress.test-service._.konghq.com.80"),
						Hosts:             kong.StringSlice("*.konghq.com"),
						Paths:             kong.StringSlice("/api/"), // default ImplementationSpecific
						PreserveHost:      new(true),
						Protocols:         nil,
		...
		},
		{
			...
			expected: map[string]kongstate.Service{
				"default.test-service.http": {
					Namespace: corev1.NamespaceDefault,
					Service: kong.Service{
						Name:           new("default.test-service.http"),
						Host:           new("test-service.default.http.svc"),
						ConnectTimeout: defaultServiceTimeoutInKongFormat(),
						Path:           new("/"),
						Port:           new(80),
						Protocol:       new("http"),
					...
					Routes: []kongstate.Route{{
						...
						Name:              new("default.test-ingress.test-service.konghq.com.http"),
						Hosts:             kong.StringSlice("konghq.com"),
						Paths:             kong.StringSlice("/api/"), // default ImplementationSpecific
						PreserveHost:      new(true),
						Protocols:         nil,
				...
				"default.svc-facade.svc.facade": {
					...
					Routes: []kongstate.Route{
						...
						},
						{
							...
							Name:              new("default.test-ingress-2.konghq.com.svc-facade.svc.facade"),
							Hosts:             kong.StringSlice("konghq.com"),
