...
func (obj *AIGatewayConsumer) GetKonnectLabels() map[string]string {
...
func (obj *AIGatewayConsumer) SetKonnectLabels(labels map[string]string) {
	if labels == nil {
...
// GetKonnectStatus returns the Konnect status contained in the AIGatewayConsumer status.
func (obj *AIGatewayConsumer) GetKonnectStatus() *konnectv1alpha2.KonnectEntityStatus {
	return &obj.Status.KonnectEntityStatus
}

// SetKonnectID sets the Konnect ID in the AIGatewayConsumer status.
func (obj *AIGatewayConsumer) SetKonnectID(id string) {
	obj.Status.ID = id
}

// GetKonnectID returns the Konnect ID in the AIGatewayConsumer status.
func (obj *AIGatewayConsumer) GetKonnectID() string {
	return obj.Status.ID
}

// GetKonnectName returns the AIGatewayConsumer's identifying name (the Konnect
// API's "name" field), distinct from GetName's Kubernetes object name.
func (obj *AIGatewayConsumer) GetKonnectName() string {
	return string(obj.Spec.APISpec.Name)
}

// GetTypeName returns the AIGatewayConsumer Kind name.
func (obj AIGatewayConsumer) GetTypeName() string {
	return "AIGatewayConsumer"
}

// GetItems returns the list of AIGatewayConsumer items.
func (obj AIGatewayConsumerList) GetItems() []AIGatewayConsumer {
	return obj.Items
}

// HasParent returns true if the AIGatewayConsumer has a parent entity.
func (obj AIGatewayConsumer) HasParent() bool {
	return true
}

// GetConditions returns the Status Conditions.
func (obj *AIGatewayConsumer) GetConditions() []metav1.Condition {
	return obj.Status.Conditions
}

// SetConditions sets the Status Conditions.
func (obj *AIGatewayConsumer) SetConditions(conditions []metav1.Condition) {
	obj.Status.Conditions = conditions
}

// GetGatewayID returns the Konnect ID of the parent Gateway.
func (obj *AIGatewayConsumer) GetGatewayID() string {
...
func (obj *AIGatewayConsumer) SetGatewayID(id string) {
	if obj.Status.GatewayID == nil {
...
func (obj *AIGatewayConsumer) GetKonnectAIGatewayRef() commonv1alpha1.ObjectRef {
...
func (obj *AIGatewayConsumer) GetStatusConditionTypeParentRefValid() string {
...
func (obj *AIGatewayConsumer) GetStatusConditionReasonParentRefValid() string {
...
func (obj *AIGatewayConsumer) GetStatusConditionReasonParentRefInvalid() string {
...
func (obj *AIGatewayConsumer) GetStatusConditionReasonParentRefNotProgrammed() string {
...
func (obj *AIGatewayConsumer) GetAncestorIDs() map[string]string {
...
func (obj *AIGatewayConsumer) SetAncestorID(kind, id string) {
	switch kind {
