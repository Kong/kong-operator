...
// -----------------------------------------------------------------------------
// aiconfigurationv1alpha1 AIGatewayCertificate - Reconciler
// -----------------------------------------------------------------------------

// AIGatewayCertificateReconciler reconciles AIGatewayCertificate resources
type AIGatewayCertificateReconciler struct {
	client.Client
...
var _ controllers.Reconciler = &AIGatewayCertificateReconciler{}

// SetupWithManager sets up the controller with the Manager.
func (r *AIGatewayCertificateReconciler) SetupWithManager(mgr ctrl.Manager) error {
	blder := ctrl.NewControllerManagedBy(mgr).
		// set the controller name
		Named("aiconfigurationv1alpha1AIGatewayCertificate").
...
func (r *AIGatewayCertificateReconciler) SetLogger(l logr.Logger) {
	r.Log = l
}

// SetCommonFields sets the shared controller dependencies.
func (r *AIGatewayCertificateReconciler) SetCommonFields(
...
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaycertificates,verbs=get;list;watch
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaycertificates/status,verbs=get;update;patch

// Reconcile processes the watched objects
func (r *AIGatewayCertificateReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	if r.Cache == nil {
		r.Cache = make(map[types.NamespacedName]types.NamespacedName)
	}
	obj := new(aiconfigurationv1alpha1.AIGatewayCertificate)
	logger := r.Log.
		WithValues("aiconfigurationv1alpha1AIGatewayCertificate", req.NamespacedName).
