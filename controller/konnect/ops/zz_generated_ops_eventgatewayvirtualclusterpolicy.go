...
func createEventGatewayVirtualClusterPolicy(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewayVirtualClusterPoliciesSDK,
	obj *configurationv1alpha1.EventGatewayVirtualClusterPolicy,
) error {
	...
	req, err := obj.Spec.APISpec.ToCreateEventGatewayVirtualClusterClusterLevelPolicyRequest()
	if err != nil {
	...
	resp, err := sdk.CreateEventGatewayVirtualClusterClusterLevelPolicy(ctx, *req)
...
func updateEventGatewayVirtualClusterPolicy(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewayVirtualClusterPoliciesSDK,
	obj *configurationv1alpha1.EventGatewayVirtualClusterPolicy,
) error {
	...
	_, err = sdk.UpdateEventGatewayVirtualClusterClusterLevelPolicy(ctx, *req)
	if errWrap := wrapErrIfKonnectOpFailed(err, UpdateOp, obj); errWrap != nil {
		return handleUpdateError(ctx, err, obj, func(ctx context.Context) error {
			return createEventGatewayVirtualClusterPolicy(ctx, sdk, obj)
		})
	}
	return nil
}

func deleteEventGatewayVirtualClusterPolicy(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewayVirtualClusterPoliciesSDK,
	obj *configurationv1alpha1.EventGatewayVirtualClusterPolicy,
) error {
	...
	_, err := sdk.DeleteEventGatewayVirtualClusterClusterLevelPolicy(ctx, sdkkonnectops.DeleteEventGatewayVirtualClusterClusterLevelPolicyRequest{
		GatewayID:        gatewayID,
...
func getEventGatewayVirtualClusterPolicyForUID(
	ctx context.Context,
	sdk sdkkonnectgo.EventGatewayVirtualClusterPoliciesSDK,
	obj *configurationv1alpha1.EventGatewayVirtualClusterPolicy,
) (string, error) {
