...
type AIGatewayConsumerGroup struct {
	...
	// +optional
	Spec AIGatewayConsumerGroupSpec `json:"spec,omitzero"`

	// +optional
	Status AIGatewayConsumerGroupStatus `json:"status,omitzero"`
}

// AIGatewayConsumerGroupList contains a list of AIGatewayConsumerGroup.
//
// +kubebuilder:object:root=true
type AIGatewayConsumerGroupList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []AIGatewayConsumerGroup `json:"items"`
}
...
type AIGatewayConsumerGroupSpec struct {
	...
	//
	// +optional
	APISpec AIGatewayConsumerGroupAPISpec `json:"apiSpec,omitzero"`
}

// AIGatewayConsumerGroupAPISpec defines the API spec fields for AIGatewayConsumerGroup.
type AIGatewayConsumerGroupAPISpec struct {
...
type AIGatewayConsumerGroupStatus struct {
