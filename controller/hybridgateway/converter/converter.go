...
type RootObject interface {
	gwtypes.HTTPRoute | gwtypes.TLSRoute | gwtypes.GRPCRoute | gwtypes.TCPRoute | gwtypes.UDPRoute | gwtypes.Gateway
}
...
func NewConverter[t RootObject](
	...
	case gwtypes.GRPCRoute:
		return newGRPCRouteConverter(&o, cl, fqdnMode, clusterDomain, referenceGrantVersion).(APIConverter[t]), nil
	...
	case gwtypes.TCPRoute:
		return newTCPRouteConverter(&o, cl, fqdnMode, clusterDomain, referenceGrantVersion).(APIConverter[t]), nil
	case gwtypes.UDPRoute:
		return newUDPRouteConverter(&o, cl, fqdnMode, clusterDomain, referenceGrantVersion).(APIConverter[t]), nil
