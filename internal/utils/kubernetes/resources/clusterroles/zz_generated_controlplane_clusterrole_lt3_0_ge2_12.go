...
// GenerateNewClusterRoleForControlPlane_lt3_0_ge2_12 is a helper to generate a ClusterRole
// resource with all the permissions needed by the controlplane deployment.
// It is used for controlplanes that match the semver constraint "<3.0, >=2.12"
func GenerateNewClusterRoleForControlPlane_lt3_0_ge2_12(controlplaneName string) *rbacv1.ClusterRole {
