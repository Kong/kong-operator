...
// KonnectEventGatewayReconciliationWatchOptions returns the watch options for
// the KonnectEventGateway.
...
func enqueueKonnectEventGatewayForKonnectAPIAuthConfiguration(
	...
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
		...
		if err := cl.List(ctx, &l, client.MatchingFields{
			index.IndexFieldKonnectEventGatewayOnAPIAuthConfiguration: auth.Namespace + "/" + auth.Name,
		}); err != nil {
			return nil
		}
