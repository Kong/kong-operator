...
- Automate CI to not use the `openapi.yaml` file from the repository, but instead use the file from imported sdk-konnect-go repo.
  We can use local go mod cache for this.
