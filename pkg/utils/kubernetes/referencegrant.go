...
func AllowedByReferenceGrants(
	...
	for _, referenceGrant := range referenceGrantList.Items {
		...
		if !lo.ContainsBy(referenceGrant.Spec.From, func(refGrantFrom gatewayv1.ReferenceGrantFrom) bool {
		...
		if lo.ContainsBy(referenceGrant.Spec.To, func(refGrantTo gatewayv1.ReferenceGrantTo) bool {
