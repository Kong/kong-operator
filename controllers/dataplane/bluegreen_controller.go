...
// BlueGreenObjectReconciler is ObjectReconciler for DataPlane objects with BlueGreen rollout strategy.
type BlueGreenObjectReconciler struct {
	client.Client
...
// Reconcile reconciles the DataPlane object with BlueGreen rollout strategy.
func (r *BlueGreenObjectReconciler) Reconcile(
	ctx context.Context,
	dataplane operatorv1beta1.DataPlane) (
	ctrl.Result, error) {
	ctx = r.ContextInjector.InjectKeyValues(ctx)
	...
	if dataplane.Spec.Deployment.Rollout == nil || dataplane.Spec.Deployment.Rollout.Strategy.BlueGreen == nil {
		...
		log.Trace(logger, "no Rollout with BlueGreen strategy specified, delegating to DataPlaneReconciler", &dataplane)
...
func (r *BlueGreenObjectReconciler) prunePreviewSubresources(
	ctx context.Context,
	dataplane *operatorv1beta1.DataPlane,
) error {
	logger := log.GetLogger(ctx, "dataplaneBlueGreen", r.DevelopmentMode)
...
func (r *BlueGreenObjectReconciler) ensureDataPlaneLiveReadyStatus(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
) (ctrl.Result, error) {
...
func (r *BlueGreenObjectReconciler) initSelectorInRolloutStatus(ctx context.Context, dataplane *operatorv1beta1.DataPlane) error {
	if dataplane.Status.RolloutStatus != nil && dataplane.Status.RolloutStatus.Deployment != nil && dataplane.Status.RolloutStatus.Deployment.Selector != "" {
		return nil
	}
...
func (r *BlueGreenObjectReconciler) ensureRolledOutCondition(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
	status metav1.ConditionStatus,
...
func (r *BlueGreenObjectReconciler) ensurePreviewAdminAPIService(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
) (op.CreatedUpdatedOrNoop, *corev1.Service, error) {
...
func (r *BlueGreenObjectReconciler) ensureDataPlaneAdminAPIInRolloutStatus(
	ctx context.Context,
	log logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
	dataplaneAdminAPIService *corev1.Service,
...
func (r *BlueGreenObjectReconciler) patchRolloutStatus(ctx context.Context, logger logr.Logger, old, updated *operatorv1beta1.DataPlane) (bool, error) {
	if rolloutStatusChanged(old, updated) {
		log.Debug(logger, "patching DataPlane status", updated, "status", updated.Status)
		return true, r.Client.Status().Patch(ctx, updated, client.MergeFrom(old))
	}
...
func (r *BlueGreenObjectReconciler) ensurePreviewIngressService(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
) (op.CreatedUpdatedOrNoop, *corev1.Service, error) {
...
func (r *BlueGreenObjectReconciler) ensureDataPlaneRolloutIngressServiceStatus(
	ctx context.Context,
	log logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
	ingressService *corev1.Service,
...
func (r *BlueGreenObjectReconciler) ensureDeploymentForDataPlane(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
	certSecret *corev1.Secret,
...
func (r *BlueGreenObjectReconciler) ensurePreviewSelectorOverridesLive(
	ctx context.Context,
	dataplane *operatorv1beta1.DataPlane,
) (updated bool, err error) {
	previewSelector := dataplane.Status.RolloutStatus.Deployment.Selector
...
func (r *BlueGreenObjectReconciler) waitForLiveServiceSelectorsPropagation(
	ctx context.Context,
	dataplane *operatorv1beta1.DataPlane,
	serviceType consts.ServiceType,
	expectedSelector map[string]string,
...
func (r *BlueGreenObjectReconciler) ensurePreviewDeploymentLabeledLive(
	ctx context.Context,
	logger logr.Logger,
	dataplane *operatorv1beta1.DataPlane,
	selector string,
...
func (r *BlueGreenObjectReconciler) resetPromoteWhenReadyAnnotation(
	ctx context.Context,
	dataplane *operatorv1beta1.DataPlane,
) error {
	oldDp := dataplane.DeepCopy()
...
func (r *BlueGreenObjectReconciler) reduceLiveDeployments(
	ctx context.Context,
	logger logr.Logger,
	dataPlane *operatorv1beta1.DataPlane,
) error {
