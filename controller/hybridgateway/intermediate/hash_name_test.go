...
func TestHashName_String(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			// With hash = 7 chars, reserved = 8 (7 + 1 dot)
			// Remaining = 253 - 8 = 245
			// prefixMax = 245 / 2 = 122
			// namespaceMax = 245 - 122 = 123
			expected: strings.Repeat("prefix", 50)[:122] + "." + strings.Repeat("namespace", 30)[:123] + ".hash123",
		},
		{
			...
			// With hash = 7 chars, reserved = 8
			// Remaining = 245, prefixMax = 122, namespaceMax = 123
		...
		},
		{
			...
			// With hash = 7 chars, reserved = 8
			// Remaining = 245, prefixMax = 122, namespaceMax = 123
			expected: "short." + strings.Repeat("verylongnamespace", 25)[:123] + ".hash789",
		},
		{
			name: "very long hash",
			hashName: HashName{
