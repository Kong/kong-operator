...
func (in *CertificateSecret) DeepCopyInto(out *CertificateSecret) {
	*out = *in
	if in.Provisioning != nil {
		...
		*out = new(CertificateProvisioningMethod)
		**out = **in
	}
	if in.SecretRef != nil {
...
func (in *ControlPlaneRef) DeepCopyInto(out *ControlPlaneRef) {
	*out = *in
	...
	if in.OnPremNamespacedRef != nil {
		in, out := &in.OnPremNamespacedRef, &out.OnPremNamespacedRef
		*out = new(NamespacedRef)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnPremAIGateway) DeepCopyInto(out *OnPremAIGateway) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnPremAIGateway.
func (in *OnPremAIGateway) DeepCopy() *OnPremAIGateway {
	if in == nil {
		return nil
	}
	out := new(OnPremAIGateway)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OnPremAIGateway) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnPremAIGatewayList) DeepCopyInto(out *OnPremAIGatewayList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]OnPremAIGateway, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnPremAIGatewayList.
func (in *OnPremAIGatewayList) DeepCopy() *OnPremAIGatewayList {
	if in == nil {
		return nil
	}
	out := new(OnPremAIGatewayList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OnPremAIGatewayList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnPremAIGatewaySpec) DeepCopyInto(out *OnPremAIGatewaySpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnPremAIGatewaySpec.
func (in *OnPremAIGatewaySpec) DeepCopy() *OnPremAIGatewaySpec {
	if in == nil {
		return nil
	}
	out := new(OnPremAIGatewaySpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnPremAIGatewayStatus) DeepCopyInto(out *OnPremAIGatewayStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnPremAIGatewayStatus.
func (in *OnPremAIGatewayStatus) DeepCopy() *OnPremAIGatewayStatus {
	if in == nil {
		return nil
	}
	out := new(OnPremAIGatewayStatus)
	in.DeepCopyInto(out)
	return out
}
