...
func (in *EventGatewayConsumeSchemaValidationPolicyConfig) DeepCopyInto(out *EventGatewayConsumeSchemaValidationPolicyConfig) {
	*out = *in
	if in.SchemaRegistry != nil {
		...
		*out = new(EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry) DeepCopyInto(out *EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
...
func (in *EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry) DeepCopy() *EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry {
	if in == nil {
		return nil
	}
	out := new(EventGatewayConsumeSchemaValidationPolicyConfigSchemaRegistry)
...
func (in *EventGatewayParsedRecordDecryptFieldsConfig) DeepCopyInto(out *EventGatewayParsedRecordDecryptFieldsConfig) {
	*out = *in
	if in.DecryptFields != nil {
		in, out := &in.DecryptFields, &out.DecryptFields
		*out = make([]EventGatewayParsedRecordDecryptionSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EventGatewayParsedRecordDecryptionSelectorPaths) DeepCopyInto(out *EventGatewayParsedRecordDecryptionSelectorPaths) {
	*out = *in
	if in.Variant1 != nil {
		...
		*out = new(EventGatewayParsedRecordDecryptionSelectorPathsVariant1)
		if **in != nil {
			in, out := *in, *out
			*out = make(EventGatewayParsedRecordDecryptionSelectorPathsVariant1, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
	...
	if in.Variant2 != nil {
		...
		*out = new(EventGatewayParsedRecordDecryptionSelectorPathsVariant2)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EventGatewayParsedRecordDecryptionSelectorPathsVariant1) DeepCopyInto(out *EventGatewayParsedRecordDecryptionSelectorPathsVariant1) {
	{
		in := &in
		*out = make(EventGatewayParsedRecordDecryptionSelectorPathsVariant1, len(*in))
		for i := range *in {
...
func (in EventGatewayParsedRecordDecryptionSelectorPathsVariant1) DeepCopy() EventGatewayParsedRecordDecryptionSelectorPathsVariant1 {
	if in == nil {
		return nil
	}
	out := new(EventGatewayParsedRecordDecryptionSelectorPathsVariant1)
...
func (in *EventGatewayParsedRecordEncryptionSelectorPaths) DeepCopyInto(out *EventGatewayParsedRecordEncryptionSelectorPaths) {
	*out = *in
	if in.Variant1 != nil {
		in, out := &in.Variant1, &out.Variant1
		*out = new(EventGatewayParsedRecordEncryptionSelectorPathsVariant1)
		if **in != nil {
			in, out := *in, *out
			*out = make(EventGatewayParsedRecordEncryptionSelectorPathsVariant1, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
	...
	if in.Variant2 != nil {
		in, out := &in.Variant2, &out.Variant2
		*out = new(EventGatewayParsedRecordEncryptionSelectorPathsVariant2)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EventGatewayParsedRecordEncryptionSelectorPathsVariant1) DeepCopyInto(out *EventGatewayParsedRecordEncryptionSelectorPathsVariant1) {
	{
		in := &in
		*out = make(EventGatewayParsedRecordEncryptionSelectorPathsVariant1, len(*in))
		for i := range *in {
...
func (in EventGatewayParsedRecordEncryptionSelectorPathsVariant1) DeepCopy() EventGatewayParsedRecordEncryptionSelectorPathsVariant1 {
	if in == nil {
		return nil
	}
	out := new(EventGatewayParsedRecordEncryptionSelectorPathsVariant1)
