...
// GenerateNewClusterRoleForControlPlane_ge3_3_lt3_4 is a helper to generate a ClusterRole
// resource with all the permissions needed by the controlplane deployment.
// It is used for controlplanes that match the semver constraint ">=3.3, <3.4"
func GenerateNewClusterRoleForControlPlane_ge3_3_lt3_4(controlplaneName string) *rbacv1.ClusterRole {
