...
func (c *aIGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AIGateway, err error) {
	result = &v1alpha1.AIGateway{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("aigateways").
		Name(name).
...
func (c *aIGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AIGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AIGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("aigateways").
...
func (c *aIGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aIGateways) Create(ctx context.Context, aIGateway *v1alpha1.AIGateway, opts v1.CreateOptions) (result *v1alpha1.AIGateway, err error) {
	result = &v1alpha1.AIGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("aigateways").
...
func (c *aIGateways) Update(ctx context.Context, aIGateway *v1alpha1.AIGateway, opts v1.UpdateOptions) (result *v1alpha1.AIGateway, err error) {
	result = &v1alpha1.AIGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aigateways").
...
func (c *aIGateways) UpdateStatus(ctx context.Context, aIGateway *v1alpha1.AIGateway, opts v1.UpdateOptions) (result *v1alpha1.AIGateway, err error) {
	result = &v1alpha1.AIGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aigateways").
...
func (c *aIGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aIGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aIGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AIGateway, err error) {
	result = &v1alpha1.AIGateway{}
