...
const (
	...
	// IndexFieldKongDataPlaneClientCertificateOnKonnectGatewayControlPlaneStatusID is the index field for KongDataPlaneCertificate -> KonnectGatewayControlPlane via the status ID.
	IndexFieldKongDataPlaneClientCertificateOnKonnectGatewayControlPlaneStatusID = "dataPlaneCertificateKonnectGatewayControlPlaneStatusID"
...
func OptionsForKongDataPlaneCertificate(cl client.Client) []Option {
	return []Option{
		...
		{
			Object:         &configurationv1alpha1.KongDataPlaneClientCertificate{},
			Field:          IndexFieldKongDataPlaneClientCertificateOnKonnectGatewayControlPlaneStatusID,
			ExtractValueFn: kongDataPlaneCertificateOnKonnectGatewayControlPlaneStatusID,
		},
		{
			Object:         &configurationv1alpha1.KongDataPlaneClientCertificate{},
...
func kongDataPlaneCertificateOnKonnectGatewayControlPlaneStatusID(object client.Object) []string {
	dpCert, ok := object.(*configurationv1alpha1.KongDataPlaneClientCertificate)
	if !ok {
		return nil
	}
	return []string{dpCert.GetControlPlaneID()}
}
