...
func TestKonnectHybridDataplane(t *testing.T) {
...
// KonnectTestBody is a function that runs the test body for KonnectExtension.
// The logic herein defined is shared between all the dataplane KonnectExtension tests.
func KonnectHybridTestBody(t *testing.T, p KonnectTestBodyParams) {
