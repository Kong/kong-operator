...
// PortalPageReconciliationWatchOptions returns the watch options for
// the PortalPage.
func PortalPageReconciliationWatchOptions(
	...
	return []func(*ctrl.Builder) *ctrl.Builder{
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.For(&konnectv1alpha1.PortalPage{})
		},
		func(b *ctrl.Builder) *ctrl.Builder {
			return b.Watches(
				&konnectv1alpha1.Portal{},
				handler.EnqueueRequestsFromMapFunc(
					enqueuePortalPageForPortal(cl),
				),
			)
		},
	}
...
func enqueuePortalPageForPortal(
	cl client.Client,
	...
	return func(ctx context.Context, obj client.Object) []reconcile.Request {
		...
		if err := cl.List(ctx, &l,
			...
			client.MatchingFields{
				index.IndexFieldPortalPageOnPortalRef: parent.Name,
			},
		); err != nil {
			return nil
		}
