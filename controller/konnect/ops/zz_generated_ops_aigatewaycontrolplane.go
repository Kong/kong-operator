...
func createAIGatewayControlPlane(
	ctx context.Context,
...
func updateAIGatewayControlPlane(
	ctx context.Context,
	sdk sdkkonnectgo.AIGatewaysSDK,
	obj *konnectv1alpha1.AIGatewayControlPlane,
) error {
	...
	if errWrap := wrapErrIfKonnectOpFailed(err, UpdateOp, obj); errWrap != nil {
		return handleUpdateError(ctx, err, obj, func(ctx context.Context) error {
			return createAIGatewayControlPlane(ctx, sdk, obj)
		})
	}
	return nil
}

func deleteAIGatewayControlPlane(
	ctx context.Context,
	sdk sdkkonnectgo.AIGatewaysSDK,
	obj *konnectv1alpha1.AIGatewayControlPlane,
) error {
...
func getAIGatewayControlPlaneForUID(
	ctx context.Context,
	sdk sdkkonnectgo.AIGatewaysSDK,
	obj *konnectv1alpha1.AIGatewayControlPlane,
) (string, error) {
