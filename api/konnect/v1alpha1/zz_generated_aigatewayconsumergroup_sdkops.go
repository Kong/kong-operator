...
// AIGatewayConsumerGroupSDKOpsFreeformKeyFields lists free-form / map data-keyed
...
var AIGatewayConsumerGroupSDKOpsFreeformKeyFields = []sdkOpsFreeformKeyField{
	{
		Path: []string{
			"labels",
		},
...
func (s *AIGatewayConsumerGroupAPISpec) marshalSDKOpsPayload() ([]byte, error) {
	...
	payload = renameKeysToSDKExcept(payload, AIGatewayConsumerGroupSDKOpsFreeformKeyFields)
