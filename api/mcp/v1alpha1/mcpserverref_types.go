...
type MCPServerRef struct {
	...
	//
	// +required
	Type MCPServerRefType `json:"type,omitempty"`

	// KonnectNamespacedRef references a MCPServer resource in the same namespace.
...
type MCPServerRefType string

const (
	// MCPServerRefTypeKonnectNamespacedRef references a MCPServer
	// resource in the same namespace as the MCPServerDataPlane.
	MCPServerRefTypeKonnectNamespacedRef MCPServerRefType = "konnectNamespacedRef"
)
