...
// -----------------------------------------------------------------------------
// aiconfigurationv1alpha1 AIGatewaySNI - Reconciler
// -----------------------------------------------------------------------------

// AIGatewaySNIReconciler reconciles AIGatewaySNI resources
type AIGatewaySNIReconciler struct {
	client.Client
...
var _ controllers.Reconciler = &AIGatewaySNIReconciler{}

// SetupWithManager sets up the controller with the Manager.
func (r *AIGatewaySNIReconciler) SetupWithManager(mgr ctrl.Manager) error {
	blder := ctrl.NewControllerManagedBy(mgr).
		// set the controller name
		Named("aiconfigurationv1alpha1AIGatewaySNI").
...
func (r *AIGatewaySNIReconciler) SetLogger(l logr.Logger) {
	r.Log = l
}

// SetCommonFields sets the shared controller dependencies.
func (r *AIGatewaySNIReconciler) SetCommonFields(
...
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaysnis/status,verbs=get;update;patch

// Reconcile processes the watched objects
func (r *AIGatewaySNIReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	if r.Cache == nil {
		r.Cache = make(map[types.NamespacedName]types.NamespacedName)
	}
	obj := new(aiconfigurationv1alpha1.AIGatewaySNI)
	logger := r.Log.
		WithValues("aiconfigurationv1alpha1AIGatewaySNI", req.NamespacedName).
