...
// +kubebuilder:deprecatedversion:warning="gateway-operator/v1alpha1 AIGateway (AI gateway v1) is deprecated and will be removed in a future release. For Konnect enabled alternative please use konnect.konghq.com/v1alpha1 AIGateway* (AI gateway v2) instead."
