...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EventGatewayListenerPort) DeepCopyInto(out *EventGatewayListenerPort) {
	{
		in := &in
		*out = make(EventGatewayListenerPort, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventGatewayListenerPort.
func (in EventGatewayListenerPort) DeepCopy() EventGatewayListenerPort {
	if in == nil {
		return nil
	}
	out := new(EventGatewayListenerPort)
	in.DeepCopyInto(out)
	return *out
}
