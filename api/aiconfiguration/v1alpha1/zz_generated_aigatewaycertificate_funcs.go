...
func (obj *AIGatewayCertificate) GetKonnectLabels() map[string]string {
...
func (obj *AIGatewayCertificate) SetKonnectLabels(labels map[string]string) {
	if labels == nil {
...
// GetKonnectStatus returns the Konnect status contained in the AIGatewayCertificate status.
func (obj *AIGatewayCertificate) GetKonnectStatus() *konnectv1alpha2.KonnectEntityStatus {
	return &obj.Status.KonnectEntityStatus
}

// SetKonnectID sets the Konnect ID in the AIGatewayCertificate status.
func (obj *AIGatewayCertificate) SetKonnectID(id string) {
	obj.Status.ID = id
}

// GetKonnectID returns the Konnect ID in the AIGatewayCertificate status.
func (obj *AIGatewayCertificate) GetKonnectID() string {
	return obj.Status.ID
}

// GetKonnectName returns the AIGatewayCertificate's identifying name (the Konnect
// API's "name" field), distinct from GetName's Kubernetes object name.
func (obj *AIGatewayCertificate) GetKonnectName() string {
	return string(obj.Spec.APISpec.Name)
}

// GetTypeName returns the AIGatewayCertificate Kind name.
func (obj AIGatewayCertificate) GetTypeName() string {
	return "AIGatewayCertificate"
}

// GetItems returns the list of AIGatewayCertificate items.
func (obj AIGatewayCertificateList) GetItems() []AIGatewayCertificate {
	return obj.Items
}

// HasParent returns true if the AIGatewayCertificate has a parent entity.
func (obj AIGatewayCertificate) HasParent() bool {
	return true
}

// GetConditions returns the Status Conditions.
func (obj *AIGatewayCertificate) GetConditions() []metav1.Condition {
	return obj.Status.Conditions
}

// SetConditions sets the Status Conditions.
func (obj *AIGatewayCertificate) SetConditions(conditions []metav1.Condition) {
	obj.Status.Conditions = conditions
}

// GetGatewayID returns the Konnect ID of the parent Gateway.
func (obj *AIGatewayCertificate) GetGatewayID() string {
...
func (obj *AIGatewayCertificate) SetGatewayID(id string) {
	if obj.Status.GatewayID == nil {
...
func (obj *AIGatewayCertificate) GetAIGatewayRef() AIGatewayRef {
...
func (obj *AIGatewayCertificate) GetParentRef() commonv1alpha1.ObjectRef {
...
func (obj *AIGatewayCertificate) SetParentRef(ref commonv1alpha1.ObjectRef) {
...
func (obj *AIGatewayCertificate) SkipKonnectReconciliation() bool {
	return obj.Spec.AIGatewayRef.TargetsOnPremAIGateway()
}

// SetParentID sets the Konnect ID of the immediate parent entity.
func (obj *AIGatewayCertificate) SetParentID(id string) {
	obj.SetGatewayID(id)
}

// GetParentGVK returns the GroupVersionKind of the parent entity.
func (obj *AIGatewayCertificate) GetParentGVK() schema.GroupVersionKind {
...
func (obj *AIGatewayCertificate) GetStatusConditionTypeParentRefValid() string {
...
func (obj *AIGatewayCertificate) GetStatusConditionReasonParentRefValid() string {
...
func (obj *AIGatewayCertificate) GetStatusConditionReasonParentRefInvalid() string {
...
func (obj *AIGatewayCertificate) GetStatusConditionReasonParentRefNotProgrammed() string {
...
func (obj *AIGatewayCertificate) GetAncestorIDs() map[string]string {
...
func (obj *AIGatewayCertificate) SetAncestorID(kind, id string) {
	switch kind {
