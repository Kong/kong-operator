...
// -----------------------------------------------------------------------------
// aiconfigurationv1alpha1 AIGatewayAuthStrategy - Reconciler
// -----------------------------------------------------------------------------

// AIGatewayAuthStrategyReconciler reconciles AIGatewayAuthStrategy resources
type AIGatewayAuthStrategyReconciler struct {
	client.Client
...
var _ controllers.Reconciler = &AIGatewayAuthStrategyReconciler{}

// SetupWithManager sets up the controller with the Manager.
func (r *AIGatewayAuthStrategyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	blder := ctrl.NewControllerManagedBy(mgr).
		// set the controller name
		Named("aiconfigurationv1alpha1AIGatewayAuthStrategy").
...
func (r *AIGatewayAuthStrategyReconciler) SetLogger(l logr.Logger) {
	r.Log = l
}

// SetCommonFields sets the shared controller dependencies.
func (r *AIGatewayAuthStrategyReconciler) SetCommonFields(
...
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewayauthstrategies,verbs=get;list;watch
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewayauthstrategies/status,verbs=get;update;patch

// Reconcile processes the watched objects
func (r *AIGatewayAuthStrategyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	if r.Cache == nil {
		r.Cache = make(map[types.NamespacedName]types.NamespacedName)
	}
	obj := new(aiconfigurationv1alpha1.AIGatewayAuthStrategy)
	logger := r.Log.
		WithValues("aiconfigurationv1alpha1AIGatewayAuthStrategy", req.NamespacedName).
	...
	if err := r.Get(ctx, req.NamespacedName, obj); err != nil {
		if apierrors.IsNotFound(err) {
			...
			if parent, ok := r.Cache[req.NamespacedName]; ok {
				...
				obj.Name = req.Name
				obj.Kind = "AIGatewayAuthStrategy"
