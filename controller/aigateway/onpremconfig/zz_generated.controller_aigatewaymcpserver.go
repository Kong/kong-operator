...
// -----------------------------------------------------------------------------
// aiconfigurationv1alpha1 AIGatewayMCPServer - Reconciler
// -----------------------------------------------------------------------------

// AIGatewayMCPServerReconciler reconciles AIGatewayMCPServer resources
type AIGatewayMCPServerReconciler struct {
	client.Client
...
var _ controllers.Reconciler = &AIGatewayMCPServerReconciler{}

// SetupWithManager sets up the controller with the Manager.
func (r *AIGatewayMCPServerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	blder := ctrl.NewControllerManagedBy(mgr).
		// set the controller name
		Named("aiconfigurationv1alpha1AIGatewayMCPServer").
...
func (r *AIGatewayMCPServerReconciler) SetLogger(l logr.Logger) {
	r.Log = l
}

// SetCommonFields sets the shared controller dependencies.
func (r *AIGatewayMCPServerReconciler) SetCommonFields(
...
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaymcpservers,verbs=get;list;watch
//+kubebuilder:rbac:groups=aiconfiguration.konghq.com,resources=aigatewaymcpservers/status,verbs=get;update;patch

// Reconcile processes the watched objects
func (r *AIGatewayMCPServerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	if r.Cache == nil {
		r.Cache = make(map[types.NamespacedName]types.NamespacedName)
	}
	obj := new(aiconfigurationv1alpha1.AIGatewayMCPServer)
	logger := r.Log.
		WithValues("aiconfigurationv1alpha1AIGatewayMCPServer", req.NamespacedName).
