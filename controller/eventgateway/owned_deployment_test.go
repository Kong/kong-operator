	...
	tests := []struct {
			...
			egdp: &eventgatewayv1alpha1.KegDataPlane{
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Config: &eventgatewayv1alpha1.KegDataPlaneConfiguration{
						Konnect: &eventgatewayv1alpha1.KonnectConfig{Domain: ptr.To("custom.example.com")},
					},
				},
			},
			keg: validKeg,
		...
		},
		{
			...
			egdp: &eventgatewayv1alpha1.KegDataPlane{
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Config: &eventgatewayv1alpha1.KegDataPlaneConfiguration{
						Konnect: &eventgatewayv1alpha1.KonnectConfig{APIRequestTimeoutSeconds: ptr.To(int32(30))},
					},
				},
			},
			keg: validKeg,
		...
		},
		{
			...
			egdp: &eventgatewayv1alpha1.KegDataPlane{
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Config: &eventgatewayv1alpha1.KegDataPlaneConfiguration{
						ConfigPollIntervalSeconds: ptr.To(int32(60)),
					},
				},
			},
			keg: validKeg,
				...
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Config: &eventgatewayv1alpha1.KegDataPlaneConfiguration{
						Observability: &eventgatewayv1alpha1.ObservabilityConfig{
							LogFlags:                           ptr.To("debug"),
							LogFormat:                          ptr.To("json"),
							MetricsRollupAllowMap:              ptr.To("my-map"),
							PolicyErrorsInfoLogIntervalSeconds: ptr.To(int32(10)),
						},
					},
				},
			},
				...
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Config: &eventgatewayv1alpha1.KegDataPlaneConfiguration{
						Runtime: &eventgatewayv1alpha1.RuntimeOptions{
							HealthListenerAddressPort: ptr.To("0.0.0.0:9090"),
							DrainDurationSeconds:      ptr.To(int32(15)),
							ShutdownTimeoutSeconds:    ptr.To(int32(30)),
						},
					},
				},
			},
...
func Test_buildDeployment(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			egdp: &eventgatewayv1alpha1.KegDataPlane{
				Spec: eventgatewayv1alpha1.KegDataPlaneSpec{
					Deployment: &eventgatewayv1alpha1.DeploymentOptions{Replicas: ptr.To(int32(3))},
				},
			},
			keg:            validKeg,
			image:          "kong/keg:test",
