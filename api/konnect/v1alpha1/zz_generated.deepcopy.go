...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CreateEventGatewayRequest) DeepCopyInto(out *CreateEventGatewayRequest) {
	*out = *in
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = new(string)
	...
	if in.MinRuntimeVersion != nil {
		in, out := &in.MinRuntimeVersion, &out.MinRuntimeVersion
		*out = new(string)
		**out = **in
	}
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreateEventGatewayRequest.
func (in *CreateEventGatewayRequest) DeepCopy() *CreateEventGatewayRequest {
	if in == nil {
		return nil
	}
	out := new(CreateEventGatewayRequest)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventGatewayMirrorKonnect) DeepCopyInto(out *EventGatewayMirrorKonnect) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventGatewayMirrorKonnect.
func (in *EventGatewayMirrorKonnect) DeepCopy() *EventGatewayMirrorKonnect {
	if in == nil {
		return nil
	}
	out := new(EventGatewayMirrorKonnect)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventGatewayMirrorSpec) DeepCopyInto(out *EventGatewayMirrorSpec) {
	*out = *in
	out.Konnect = in.Konnect
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventGatewayMirrorSpec.
func (in *EventGatewayMirrorSpec) DeepCopy() *EventGatewayMirrorSpec {
	if in == nil {
		return nil
	}
	out := new(EventGatewayMirrorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KonnectEventGatewaySpec) DeepCopyInto(out *KonnectEventGatewaySpec) {
	*out = *in
	...
	if in.CreateGatewayRequest != nil {
		in, out := &in.CreateGatewayRequest, &out.CreateGatewayRequest
		*out = new(CreateEventGatewayRequest)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPServerWorkloadsStatus) DeepCopyInto(out *MCPServerWorkloadsStatus) {
	*out = *in
	if in.Version != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPServerWorkloadsStatus.
func (in *MCPServerWorkloadsStatus) DeepCopy() *MCPServerWorkloadsStatus {
	if in == nil {
		return nil
	}
	out := new(MCPServerWorkloadsStatus)
	in.DeepCopyInto(out)
	return out
}
