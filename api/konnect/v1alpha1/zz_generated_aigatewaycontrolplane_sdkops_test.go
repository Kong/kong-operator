...
func TestAIGatewayControlPlaneAPISpec_ToCreateAIGatewayRequest(t *testing.T) {
	spec := &AIGatewayControlPlaneAPISpec{
...
func TestAIGatewayControlPlaneAPISpec_ToUpdateAIGatewayRequest(t *testing.T) {
	spec := &AIGatewayControlPlaneAPISpec{
		Description: "test-value",
		DisplayName: "test-value",
		Labels: PublicLabels{"test-key": "test-value"},
